...
public class BasicAssertion2UsingBrowser {
	...
	public void remembermeCheckBoxValidation() {
		...
		Assert.assertEquals(actual, expected, " :The rememeberme checkbox is not selected");
	}
	 ...
	 * @Test
	 * 
	 * @Parameters({"para1","para2","para3","para4"}) public void
	 * parameterTesting(int a, int b, int c,String d) { System.out.println(a);
